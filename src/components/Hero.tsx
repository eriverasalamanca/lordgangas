    ...
    <div className="hero-banner">
      <div className="hero-content">
        ...
        <div className="hero-cta">
          ...
          <button className="btn btn-primary" onClick={() => scrollToSection('.education-buttons')}>  
            Apostamos por la Educación
          </button>
        </div>
        <p className="hero-info">
          Únete a <strong>4000+ usuarios activos</strong> que ahorran diariamente con Lord Gangas
        </p>
      </div>
    </div>
  );
